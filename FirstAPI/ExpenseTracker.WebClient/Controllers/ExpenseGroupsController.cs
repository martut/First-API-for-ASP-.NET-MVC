    ...
    public class ExpenseGroupsController : Controller
    {
        ...
        public async Task<ActionResult> Index(int? page = 1)
        {
            ...
            HttpResponseMessage response = await client.GetAsync(
                "api/expensegroups?sort=expensegroupstatusid,title&page=" + page + "&pagesize=5");
        ...
        public async Task<ActionResult> Edit(int id, ExpenseGroup expenseGroup)
        {
            try
            {
                ...
                patchDoc.Replace(e => e.Title, expenseGroup.Title);
                patchDoc.Replace(e => e.Description, expenseGroup.Description);
